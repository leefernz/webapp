     ...
     stages {
        ...
        stage ('Publish to Nexus'){
           steps {
                ...
                classifier: '', file:  "target/${ArtifactId}-${Version}.war", type: 'war']], 
                credentialsId: '65058126-641b-494b-980d-68c2c4f7b110', groupId: "${GroupId}", 
                nexusUrl: '172.20.10.237:8081', nexusVersion: 'nexus3', protocol: 'http',
